...
setwd("~/Dropbox/UCD_Files/Teaching/Math4027/Code/")
...
laf = Lest(pppol[,af], r = r, correction = "Ripley")$iso - r # Lhat for affected
...
lrl <- pbapply::pbsapply(1:499, FUN = function(i) {
  xsim <- 
  Lest(pppol[,sample.int(n, size = naf)], 
